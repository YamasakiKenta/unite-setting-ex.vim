...
function! unite_setting_ex#sub_setting_syntax(args, context) 
	syntax match uniteSource__settings_const / \zs+.\{-}+\>/ containedin=uniteSource__settings contained
	syntax match uniteSource__settings_choose / \zs<.\{-}>/ containedin=uniteSource__settings contained
	syntax match uniteSource__settings_choose / \zs|.\{-}>/ containedin=uniteSource__settings contained
